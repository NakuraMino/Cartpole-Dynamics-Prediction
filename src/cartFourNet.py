...
Original file is located at
    https://colab.research.google.com/drive/14-bf2nca3Xa7Pr_r-crJqv0rckh8cw5j
"""
...
if __name__ == "__main__":
  ...
  path = './image_dataset/'
  dataset = CartpoleDataset('data.csv', path, 4, H=128, W=128)

  net = CartFourNet().float().to("cuda")
