...
Original file is located at
    https://colab.research.google.com/drive/1eXM8Pkg1Hxvxj2-8mvZqjFSbryYf80Lz
"""
...
if __name__ == "__main__":
  ...
  path = './image_dataset/'
  dataset = CartpoleDataset('data.csv', path, 3, H=128, W=128)

  net = CartThreeNet().float().to("cuda")
